...
class RequestHandler_answer:
    ...
    def callback(self, request: Request) -> None:
        ...
        request.headers.append({"name": 'X-Robocon-Workshop-Custom-Header', "value": {"type": "string", "value": "Hello"}})
        request.continue_request(headers=request.headers)
